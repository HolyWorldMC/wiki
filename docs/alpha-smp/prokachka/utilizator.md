...
<mark style="color:violet;">**Утилизатор**</mark> — это блок в локациях, который перерабатывает ненужные вещи в ресурсы, аметисты и опыт. Свой поставить нельзя: пользуются тем, что нашли в локации.

<figure><img src="../.gitbook/assets/image (62).png" alt="" width="188"><figcaption></figcaption></figure>

## Где найти

Утилизатор предусмотрен не в каждой локации, и даже там, где он есть, появляется не всегда. Базовый КПД зависит от [локации](../dobycha-resursov/lokacii.md):

...
<div data-with-frame="true"><figure><img src="../.gitbook/assets/ah-main (1).png" alt=""><figcaption><p>Главное меню Аукциона /ah</p></figcaption></figure></div>

Меню Аукциона можно открыть с помощью команды `/ah`.

## Как купить предмет

<div data-with-frame="true"><figure><img src="../.gitbook/assets/ah-item (1) (1).png" alt=""><figcaption><p>Пример, как выглядит товар на Аукционе</p></figcaption></figure></div>

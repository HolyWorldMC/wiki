...
## <mark style="color:cyan;">**Парящий Остров**</mark>

<figure><img src=".gitbook/assets/image (7).png" alt=""><figcaption></figcaption></figure>

_Сложность_ ★★☆☆☆

Парящий остров – это небесная локация, состоящая из верхнего острова с постройками и подземной частью, богатой рудами. Наверху расположены здания с рассадниками испытаний, а внизу можно добывать ценные руды. Уровень опасности здесь средний.

**Рассадник испытаний: спавнит чаще всего враждебных мобов (фантом, скелет, эндермен, зомби, крипер и др.)**
...
## <mark style="color:pink;">**Добрая пещера (Цветущая)**</mark>

<figure><img src=".gitbook/assets/image (6).png" alt=""><figcaption></figcaption></figure>

_Сложность_ ★★★☆☆

Цветущая пещера – это подземная локация с зелёным освещением. Внутри можно найти множество руд, хранилищ и полезных ресурсов. Уровень опасности средний.

\- внутри пещеры есть места, где можно заприватить свой регион. Можно обустроить приват прямо внутри локации, пользуясь близостью к ресурсам и хранилищам.

**Рассадник испытаний: спавнит чаще всего враждебных мобов (пещерный паук, паук, скелет, зомби, крипер и др.)**
...
Карьеры – это особые локации, где игроки могут автоматически добывать ресурсы. В локации находится постройка, где можно найти стол с выбором руд, стойка, где можно заправить топливо и ниже – лампа включения. Внизу шахты находится платформа, на которой происходит бурение руд, а добытые ресурсы остаются прямо там.

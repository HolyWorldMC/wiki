...
<div data-with-frame="true"><figure><img src="../.gitbook/assets/b_main (2).png" alt=""><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="../.gitbook/assets/b_percent (1).png" alt=""><figcaption></figcaption></figure></div>
...
{% hint style="info" %}
За прохождение Этапов у Скупца вы сможете повышать максимальный доступный у него объём торгов. Если по умолчанию вы можете продать Скупцу целых 256 стаков любого предмета, то выполнив все Этапы, лимит уже будет составлять более 400 стаков.
{% endhint %}

## Ежедневная сделка

<div data-with-frame="true"><figure><img src="../.gitbook/assets/b_daily (2).png" alt=""><figcaption></figcaption></figure></div>

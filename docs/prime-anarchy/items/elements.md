...
<figure><img src="../.gitbook/assets/element_item (2).png" alt=""><figcaption></figcaption></figure>
...
* Скрафтить из Крупиц — [собрать 9 Крупиц и соединить их в верстаке](#user-content-fn-1)[^1] → получится 1 Элемент.
...
<div data-with-frame="true"><figure><img src="../.gitbook/assets/element_chest_prew.png" alt=""><figcaption></figcaption></figure></div>

Элементный сундук — это особое хранилище где можно хранить Элементы. Использовать обычные сундуки или другие хранилища для Элементов нельзя.

| Крафт           | <p><img src="../.gitbook/assets/inventory (1) (1).png" alt="" data-size="original"></p><p>1 медный сундук + 8 Элементов</p> |
| --------------- | --------------------------------------------------------------------------------------------------------------------------- |
| Внешний признак | У сундука есть характерный блеск, поэтому её можно отличить от обычного сундук.                                             |
| Ограничение     | Элементы нельзя хранить в Аду и Энде.                                                                                       |

{% hint style="warning" %}
Сундук специально сделан заметным и ограниченным по размещению, чтобы хранение Элементов было рискованным и другие игроки могли охотиться за ними.
{% endhint %}



[^1]: <img src="../.gitbook/assets/inventory (3).png" alt="" data-size="original">

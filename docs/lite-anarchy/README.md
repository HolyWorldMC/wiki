...
<table><thead><tr><th width="202"></th><th></th></tr></thead><tbody><tr><td>Айпи адрес</td><td><code>lite.holyworld.ru</code> (Для игроков из России)<br><code>lite.holyworld.me</code> (Для игроков из других стран)</td></tr><tr><td>Особый айпи для РФ</td><td><code>msk.holyworld.ru</code><br>1. Для игроков из России<br>2. Минимальный пинг на Анархиях</td></tr><tr><td>Версия игры</td><td>1.16.5-1.21.11</td></tr></tbody></table>
...
Режим Лайт Анархия включает в себя более чем 60+ доступных серверов для игры, а чтобы сбалансировать как одиночную, так и командную игру, сервера поделены на типы:
...
Промежуток времени между вайпом составляет не менее 5 недель (\~35 дней). За 5 дней до вайпа администрация уведомляет игроков о будущем вайпе в соцсетях Лайт Анархии.

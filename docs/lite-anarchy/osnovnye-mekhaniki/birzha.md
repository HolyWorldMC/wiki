...
- это торговая площадка для обмена внутриигровых монет на коины, которые приобретаются за реальную валюту на официальном сайте сервера. Система позволяет игрокам торговать между собой игровой валютой.
...
Все операции происходят через систему заявок с указанием курса обмена.
...
- Курс обмена (автоматический или пользовательский) - Общая стоимость сделки в коинах
...
- Полная покупка
- приобретение всех монет с выбранной заявки
- Частичная покупка
- приобретение определенного количества монет

...
**Описание:** специальный контейнер с ценными предметами. Открывается сразу при покупке.

#### Яйцо дракона — 5000 очков
**Требования:** наличие Premium

**Описание:** редкий предмет для получения уникальных наград. Стартовая стоимость обмена яйца из `/bpshop` на сапфиры - 250 (максимум - 1500).

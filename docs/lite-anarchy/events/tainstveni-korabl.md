...
**Требование:** 4 отмычки уникальной редкости После внесения отмычек система начинает обратный отсчет, постепенно уменьшая требуемое количество отмычек до момента активации клада.

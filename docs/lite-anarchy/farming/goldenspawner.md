...
Спавнер убивает в среднем 10 мобов в секунду. Это в \~60 раз быстрее обычных спавнеров. Мобы спавнятся только если есть подходящее место для их спавна (с учётом пространства и света).

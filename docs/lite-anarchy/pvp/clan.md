...
* **Название клана:** до 12 символов (поддерживает цветовые коды. _Использование цветового кода засчитывается за символы_).
...
* Час онлайна в клане можно докупить за сапфиры в меню прокачки клана.
...
* Доступна лидеру клана и старшине Назначить игрока старшиной: `/clan foreman [ник игрока]` Установка точки: `/clan sethome [название]`
* Максимум: 3 клановых сетхома (Открываются при наличии определённого количества часов онлайна клана 9/18/27). Для телепортации на точки дома используется команда `/clan home [название точки дома]`

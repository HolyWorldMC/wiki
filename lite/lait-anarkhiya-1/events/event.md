...
{% hint style="info" %}
На территории ивента летают Блуждающие Кубы, при нажатии правой кнопкой мыши по нему вы получите предмет «Куб», который позже можно обменять на «Кубики».
{% endhint %}

## Этап 1. Ожидание

После появления куб **8 минут ничего не делает**.

## Этап 2. Взрыв

Когда время ожидания заканчивается, куб **взрывается**.

После взрыва на его гранях появляются **цветные точки** (черный, фиолетовый или красный бетон) разного уровня.

### Получение наград

Каждую точку (черный, фиолетовый или красный бетон) можно **сломать только один раз**.

За это вы получите случайные награды, среди которых могут быть:

* Кубы разных ценностей;
* полезные ресурсы;
* другие ценные предметы.

Полученные кубы можно **сразу активировать**, чтобы мгновенно получить награду на баланс.

### Следующий взрыв

После каждого взрыва начинается новый отсчёт времени.

Рядом с кубом отображается **таймер**, который показывает, сколько осталось до следующего взрыва и появления новых точек.

{% hint style="warning" %}
Во время каждого взрыва куб наносит **урон всем игрокам поблизости**. Следите за таймером и вовремя отходите на безопасное расстояние.
{% endhint %}
